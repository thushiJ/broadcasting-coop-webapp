...
import TVSeriesCarouselCard from '../shared/TVSeriesCarouselCard';

function TrendingNearYou({ cardDetails }: any) {
	const cards = [
		{
			id: 1,
			time: '1h 18m',
	...
	return (
		<div>
			<div className='flex justify-between w-[95%]'>
				<h1 className='text-white md:text-xl text-md '>Trending near you</h1>
